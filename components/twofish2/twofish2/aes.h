...
*/
#ifndef twofish2_aes_h
#define twofish2_aes_h
...
extern int	reKey(keyInstance *key);	/* do key schedule using modified key.keyDwords */

extern int twofish2_crypt(int mode, int keySize, char* in, char* keyMaterial, int dir_encrypt);
